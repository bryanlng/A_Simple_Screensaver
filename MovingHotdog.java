 ...
 *Mrs. Gallatin
 *MovingHotdog
 *Makes a MovingHotdog which extends Hotdog and defines its movement patterns
**/

import javax.swing.JComponent;
import java.awt.Graphics2D;

public class MovingHotdog extends Hotdog implements Identifiable // Identifiable is interface I created
{
   ...
   public static final int WIDTH = 30; //65
   public static final int HEIGHT = 5; //20
   
   /**
      Creates a new MovingHotdog instance
      @param x the x coordinate of the top left corner
      @param y the y coordinate of the top left corner
      @param step Step in pixels the MovingHotdog will move each time
      @param delay The delay to wait between each step
      @param direction In which direction the MovingHotdog will move
      @param component The component
    */
   public MovingHotdog(int x, int y, int step, int delay, double direction, JComponent component)
   {
      super(x, y);
      this.step = step;
      this.delay = delay;
   ...
   /**
    * Adjusts the MovingHotdog's x and y locations based on the direction it is going.
    * Checks if the Hotdog has 1) steps have passed 100 2) been eaten yet 3) is out of bounds
    * 1) If steps > 100, it generates a new random step value between 2-22 and a new random direction value between 1 - 232. 
    * 2) If the MovingHotdog's x coordinate is [between (360 - WIDTH) and 410] and its y coordiante is [between (460 - HEIGHT) and 600],
    ...
    * 3) If Hotdog is out of bounds, it changes its direction to be somewhat perpandicular of its original direction and increases velocity ( represented by step)
...
//   	  	System.out.println ("");
   	  	 ...
   	  	 if( step > 100)
		 {
			...
			System.out.println ("direction: " + direction);
   	  	 ...
   	  	 //if(  (super.getX() > 297 - WIDTH && super.getX() < 480) && (super.getY() > (385 - HEIGHT) && super.getY() < 600) )
   	  	 ...
   	  	 else if(  (super.getX() < 0 || super.getX() > 720) || (super.getY() < 0 || super.getY() > 570) )
   	  	 {
			...
			else if(super.getX() > 715) //hitting right wall
			{
